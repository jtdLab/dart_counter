...
import 'application/home/home_bloc.dart' as _i51;
...
import 'infrastructure/auth/firebase_auth_facade.dart' as _i43;
...
import 'infrastructure/friend/friend_facade.dart' as _i52;
...
import 'infrastructure/play/play_online_facade.dart' as _i53;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i45.IPlayOnlineFacade>(
      () => _i46.MockedPlayOnlineFacade(get<_i25.IUserFacade>()),
      registerFor: {_dev});
  gh.lazySingleton<_i25.IUserFacade>(
      () => _i47.UserFacade(
          get<_i7.FirebaseFirestore>(),
  ...
  gh.lazySingleton<_i48.PlayBloc>(() => _i48.PlayBloc(
      get<_i23.IPlayOfflineFacade>(), get<_i45.IPlayOnlineFacade>()));
  gh.lazySingleton<_i49.PostGameBloc>(
      () => _i49.PostGameBloc(get<_i48.PlayBloc>()));
  gh.lazySingleton<_i50.CreateGameBloc>(() =>
      _i50.CreateGameBloc(get<_i48.PlayBloc>(), get<_i16.IFriendFacade>()));
  gh.lazySingleton<_i51.HomeBloc>(() => _i51.HomeBloc(
      ...
      get<_i48.PlayBloc>()));
  gh.lazySingleton<_i16.IFriendFacade>(
      () => _i52.FriendFacade(get<_i11.IAuthFacade>(), get<_i25.IUserFacade>(),
          get<_i7.FirebaseFirestore>(), get<_i33.SocialClient>()),
      registerFor: {_test, _prod});
  gh.lazySingleton<_i45.IPlayOnlineFacade>(
      () =>
          _i53.PlayOnlineFacade(get<_i4.DartClient>(), get<_i25.IUserFacade>()),
      registerFor: {_test, _prod});
  gh.lazySingleton<_i54.InGameBloc>(
      () => _i54.InGameBloc(get<_i48.PlayBloc>()));
  gh.factory<_i55.InvitationsBloc>(() => _i55.InvitationsBloc(
      get<_i21.IGameInvitationFacade>(), get<_i48.PlayBloc>()));
