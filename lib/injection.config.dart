...
import 'application/auth/forgot_password/forgot_password_bloc.dart' as _i67;
import 'application/auth/sign_in/sign_in_bloc.dart' as _i55;
import 'application/auth/sign_up/sign_up_bloc.dart' as _i56;
import 'application/main/friends/friends_bloc.dart' as _i81;
import 'application/main/friends/search_user/search_user_bloc.dart' as _i78;
import 'application/main/game_history/game_history_bloc.dart' as _i68;
import 'application/main/game_invitations/game_invitations_bloc.dart' as _i82;
import 'application/main/home/create_online_game/create_online_game_cubit.dart'
    as _i80;
import 'application/main/home/home_bloc.dart' as _i83;
...
import 'application/main/play/online/create_game/create_online_game_bloc.dart'
    as _i79;
import 'application/main/play/online/in_game/in_online_game_bloc.dart' as _i76;
...
import 'domain/friend/i_friend_service.dart' as _i70;
...
import 'domain/play/online/i_play_online_service.dart' as _i73;
...
import 'infrastructure/auth/firebase_auth_service.dart' as _i69;
...
import 'infrastructure/core/firebase_injectable_module.dart' as _i88;
import 'infrastructure/core/jtd_injectable_module.dart' as _i87;
import 'infrastructure/friend/friend_service.dart' as _i84;
import 'infrastructure/friend/mocked_friend_service.dart' as _i71;
import 'infrastructure/game_history/game_history_service.dart' as _i85;
import 'infrastructure/game_history/mocked_game_history_service.dart' as _i25;
import 'infrastructure/game_invitation/game_invitation_service.dart' as _i72;
...
import 'infrastructure/play/online/mocked_play_online_service.dart' as _i74;
import 'infrastructure/play/online/play_online_service.dart' as _i86;
...
import 'infrastructure/user/user_service.dart' as _i75;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i65.DoubleTrainingWatcherCubit>(() =>
      _i65.DoubleTrainingWatcherCubit(get<_i22.IDoubleTrainingService>()));
  gh.lazySingleton<_i66.EditProfileImageBloc>(
      () => _i66.EditProfileImageBloc(get<_i34.IUserService>()));
  gh.lazySingleton<_i67.ForgotPasswordBloc>(
      () => _i67.ForgotPasswordBloc(get<_i13.IAuthService>()));
  gh.lazySingleton<_i68.GameHistoryBloc>(() => _i68.GameHistoryBloc(
      get<_i34.IUserService>(), get<_i24.IGameHistoryService>()));
  gh.lazySingleton<_i13.IAuthService>(
      () => _i69.FirebaseAuthService(
          get<_i8.FirebaseAuth>(),
          get<_i12.GoogleSignIn>(),
          get<_i7.FacebookAuth>(),
          get<_i58.SocialClient>()),
      registerFor: {_test, _prod});
  gh.lazySingleton<_i70.IFriendService>(
      () => _i71.MockedFriendService(
          get<_i13.IAuthService>(), get<_i34.IUserService>()),
      registerFor: {_dev});
  gh.lazySingleton<_i26.IGameInvitationService>(
      () => _i72.GameInvitationService(
          get<_i13.IAuthService>(),
          get<_i9.FirebaseFirestore>(),
          get<_i58.SocialClient>(),
          get<_i5.DartClient>()),
      registerFor: {_test, _prod});
  gh.lazySingleton<_i73.IPlayOnlineService>(
      () => _i74.MockedPlayOnlineService(get<_i34.IUserService>()),
      registerFor: {_dev});
  gh.lazySingleton<_i34.IUserService>(
      () => _i75.UserService(
          get<_i9.FirebaseFirestore>(),
          ...
          get<_i58.SocialClient>()),
      registerFor: {_test, _prod});
  gh.lazySingleton<_i76.InOnlineGameBloc>(
      () => _i76.InOnlineGameBloc(get<_i73.IPlayOnlineService>()));
  gh.lazySingleton<_i77.PlayOnlineWatcherCubit>(
      () => _i77.PlayOnlineWatcherCubit(get<_i73.IPlayOnlineService>()));
  gh.lazySingleton<_i78.SearchUserBloc>(
      () => _i78.SearchUserBloc(get<_i70.IFriendService>()));
  gh.lazySingleton<_i79.CreateOnlineGameBloc>(
      () => _i79.CreateOnlineGameBloc(get<_i73.IPlayOnlineService>()));
  gh.lazySingleton<_i80.CreateOnlineGameCubit>(
      () => _i80.CreateOnlineGameCubit(get<_i73.IPlayOnlineService>()));
  gh.lazySingleton<_i81.FriendsBloc>(
      () => _i81.FriendsBloc(get<_i70.IFriendService>()));
  gh.lazySingleton<_i82.GameInvitationsBloc>(() => _i82.GameInvitationsBloc(
      get<_i73.IPlayOnlineService>(), get<_i26.IGameInvitationService>()));
  gh.lazySingleton<_i83.HomeBloc>(() => _i83.HomeBloc(get<_i34.IUserService>(),
      get<_i26.IGameInvitationService>(), get<_i70.IFriendService>()));
  gh.lazySingleton<_i70.IFriendService>(
      () => _i84.FriendService(
          get<_i13.IAuthService>(),
      ...
      registerFor: {_test, _prod});
  gh.lazySingleton<_i24.IGameHistoryService>(
      () => _i85.GameHistoryService(get<_i9.FirebaseFirestore>(),
          get<_i34.IUserService>(), get<_i70.IFriendService>()),
      registerFor: {_test, _prod});
  gh.lazySingleton<_i73.IPlayOnlineService>(
      () => _i86.PlayOnlineService(get<_i5.DartClient>(),
          get<_i34.IUserService>(), get<_i70.IFriendService>()),
      registerFor: {_test, _prod});
  return get;
}

class _$JtdInjectableModule extends _i87.JtdInjectableModule {}

class _$FireBaseInjectableModule extends _i88.FireBaseInjectableModule {}
