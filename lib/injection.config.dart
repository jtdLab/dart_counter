...
import 'package:social_client/social_client.dart' as _i80;

import 'application/auth/forgot_password/forgot_password_bloc.dart' as _i92;
import 'application/auth/sign_in/sign_in_bloc.dart' as _i77;
import 'application/auth/sign_up/sign_up_bloc.dart' as _i78;
...
import 'application/main/core/play/online/play_online_cubit.dart' as _i72;
import 'application/main/core/user/user_cubit.dart' as _i81;
import 'application/main/friends/friends_bloc.dart' as _i93;
import 'application/main/friends/more/more_bloc.dart' as _i69;
import 'application/main/friends/search_user/search_user_bloc.dart' as _i75;
...
import 'application/main/play/shared/in_game/darts_displayer/darts_displayer_bloc.dart'
    as _i89;
import 'application/main/profile/profile_bloc.dart' as _i73;
import 'application/main/settings/change_email/change_email_bloc.dart' as _i84;
...
import 'application/main/settings/edit_profile_image/edit_profile_image_bloc.dart'
    as _i91;
import 'application/main/settings/settings_bloc.dart' as _i76;
...
import 'application/main/training/single_training/watcher/single_training_watcher_cubit.dart'
    as _i79;
import 'application/shared/auth/auth_bloc.dart' as _i82;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i70.PlayOfflineCubit>(() => _i70.PlayOfflineCubit());
  gh.factoryParam<_i71.PlayOfflineWatcherCubit, List<Object>, dynamic>(
      (otherDependencies, _) => _i71.PlayOfflineWatcherCubit.injectable(
          get<_i39.IPlayOfflineService>(), otherDependencies));
  gh.factory<_i72.PlayOnlineCubit>(() => _i72.PlayOnlineCubit());
  gh.factoryParam<_i73.ProfileBloc, List<Object>, dynamic>(
      (otherDependencies, _) => _i73.ProfileBloc.injectable(otherDependencies));
  gh.factory<_i74.ScoreTrainingWatcherCubit>(
      () => _i74.ScoreTrainingWatcherCubit(get<_i41.IScoreTrainingService>()));
  gh.factory<_i75.SearchUserBloc>(
      () => _i75.SearchUserBloc(get<_i33.IFriendService>()));
  gh.factory<_i76.SettingsBloc>(
      () => _i76.SettingsBloc(get<_i19.IAuthService>()));
  gh.factory<_i77.SignInBloc>(() => _i77.SignInBloc(get<_i19.IAuthService>()));
  gh.factory<_i78.SignUpBloc>(() => _i78.SignUpBloc(get<_i19.IAuthService>()));
  gh.factory<_i79.SingleTrainingWatcherCubit>(() =>
      _i79.SingleTrainingWatcherCubit(get<_i43.ISingleTrainingService>()));
  gh.lazySingleton<_i80.SocialClient>(() => jtdInjectableModule.socialClient);
  gh.factory<_i81.UserCubit>(() => _i81.UserCubit(get<_i45.IUserService>()));
  gh.factory<_i82.AuthBloc>(() => _i82.AuthBloc(get<_i19.IAuthService>()));
  gh.factory<_i83.BobsTwentySevenWatcherCubit>(() =>
      _i83.BobsTwentySevenWatcherCubit(get<_i21.IBobsTwentySevenService>()));
  gh.factory<_i84.ChangeEmailBloc>(
      () => _i84.ChangeEmailBloc(get<_i45.IUserService>()));
  gh.factory<_i85.ChangePasswordBloc>(
      () => _i85.ChangePasswordBloc(get<_i19.IAuthService>()));
  gh.factory<_i86.ChangeUsernameBloc>(
      () => _i86.ChangeUsernameBloc(get<_i45.IUserService>()));
  gh.factory<_i87.CreateOfflineGameBloc>(
      () => _i87.CreateOfflineGameBloc(get<_i39.IPlayOfflineService>()));
  ...
  gh.factory<_i105.PlayOnlineWatcherCubit>(
      () => _i105.PlayOnlineWatcherCubit(get<_i99.IPlayOnlineService>()));
  gh.factory<_i106.CreateOnlineGameBloc>(
      () => _i106.CreateOnlineGameBloc(get<_i99.IPlayOnlineService>()));
  gh.factory<_i107.CreateOnlineGameCubit>(
      () => _i107.CreateOnlineGameCubit(get<_i99.IPlayOnlineService>()));
