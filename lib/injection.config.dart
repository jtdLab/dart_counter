...
import 'application/friends/friends_bloc.dart' as _i66;
import 'application/friends/more/more_bloc.dart' as _i59;
import 'application/friends/search_user/search_user_bloc.dart' as _i61;
...
import 'application/in_game/detailed_input_area/detailed_input_area_bloc.dart'
    as _i65;
import 'application/in_game/in_game_bloc.dart' as _i58;
...
import 'infrastructure/core/firebase_injectable_module.dart' as _i73;
import 'infrastructure/core/jtd_injectable_module.dart' as _i72;
import 'infrastructure/friend/friend_service.dart' as _i69;
import 'infrastructure/friend/mocked_friend_service.dart' as _i53;
import 'infrastructure/game_history/game_history_service.dart' as _i70;
...
import 'infrastructure/play/online/play_online_service.dart' as _i71;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i31.IUserService>(
      () => _i57.UserService(
          ...
          get<_i39.SocialClient>()),
      registerFor: {_test, _prod});
  gh.lazySingleton<_i58.InGameBloc>(() => _i58.InGameBloc(
      get<_i25.IPlayOfflineService>(), get<_i55.IPlayOnlineService>()));
  gh.lazySingleton<_i59.MoreBloc>(
      () => _i59.MoreBloc(get<_i52.IFriendService>()));
  gh.lazySingleton<_i60.OpticalInputAreaBloc>(
      () => _i60.OpticalInputAreaBloc(get<_i58.InGameBloc>()));
  gh.lazySingleton<_i61.SearchUserBloc>(
      () => _i61.SearchUserBloc(get<_i52.IFriendService>()));
  gh.lazySingleton<_i62.SpeechInputAreaBloc>(
      () => _i62.SpeechInputAreaBloc(get<_i58.InGameBloc>()));
  gh.lazySingleton<_i63.StandardInputAreaBloc>(
      () => _i63.StandardInputAreaBloc(get<_i58.InGameBloc>()));
  gh.lazySingleton<_i64.CheckoutDetailsBloc>(
      () => _i64.CheckoutDetailsBloc(get<_i58.InGameBloc>()));
  gh.lazySingleton<_i65.DetailedInputAreaBloc>(
      () => _i65.DetailedInputAreaBloc(get<_i58.InGameBloc>()));
  gh.lazySingleton<_i66.FriendsBloc>(
      () => _i66.FriendsBloc(get<_i52.IFriendService>()));
  gh.lazySingleton<_i67.GameInvitationsBloc>(() => _i67.GameInvitationsBloc(
      get<_i55.IPlayOnlineService>(), get<_i23.IGameInvitationService>()));
  ...
  gh.lazySingleton<_i52.IFriendService>(
      ...
      registerFor: {_test, _prod});
  gh.lazySingleton<_i21.IGameHistoryService>(
      () => _i70.GameHistoryService(get<_i8.FirebaseFirestore>(),
          get<_i31.IUserService>(), get<_i52.IFriendService>()),
      registerFor: {_test, _prod});
  gh.lazySingleton<_i55.IPlayOnlineService>(
      () => _i71.PlayOnlineService(get<_i5.DartClient>(),
          get<_i31.IUserService>(), get<_i52.IFriendService>()),
      registerFor: {_test, _prod});
  return get;
}

class _$JtdInjectableModule extends _i72.JtdInjectableModule {}
