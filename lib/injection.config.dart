...
import 'package:social_client/social_client.dart' as _i81;

import 'application/authenticated/core/friends/friends_cubit.dart' as _i96;
import 'application/authenticated/core/game_invitations/game_invitations_cubit.dart'
    as _i98;
import 'application/authenticated/core/user/user_cubit.dart' as _i82;
import 'application/authenticated/friends/friends_bloc.dart' as _i95;
...
import 'application/authenticated/friends/search_user/search_user_bloc.dart'
    as _i76;
import 'application/authenticated/game_history/game_history_bloc.dart' as _i97;
...
import 'application/authenticated/play/shared/in_game/darts_displayer/darts_displayer_bloc.dart'
    as _i91;
import 'application/authenticated/profile/profile_bloc.dart' as _i72;
...
import 'application/authenticated/settings/edit_profile_image/edit_profile_image_bloc.dart'
    as _i93;
import 'application/authenticated/settings/settings_bloc.dart' as _i77;
...
import 'application/authenticated/training/single_training/watcher/single_training_watcher_cubit.dart'
    as _i80;
import 'application/shared/auth/auth_bloc.dart' as _i83;
import 'application/unauthenticated/forgot_password/forgot_password_bloc.dart'
    as _i94;
import 'application/unauthenticated/sign_in/sign_in_bloc.dart' as _i78;
import 'application/unauthenticated/sign_up/sign_up_bloc.dart' as _i79;
...
import 'domain/play/online/i_play_online_service.dart' as _i102;
...
import 'infrastructure/auth/firebase_auth_service.dart' as _i100;
...
import 'infrastructure/connectivity/connectivity_service.dart' as _i29;
import 'infrastructure/connectivity/fake_connectivity_service.dart' as _i30;
import 'infrastructure/core/firebase_injectable_module.dart' as _i115;
import 'infrastructure/core/jtd_injectable_module.dart' as _i114;
import 'infrastructure/friend/fake_friend_service.dart' as _i36;
import 'infrastructure/friend/friend_service.dart' as _i111;
import 'infrastructure/game_history/fake_game_history_service.dart' as _i38;
import 'infrastructure/game_history/game_history_service.dart' as _i112;
import 'infrastructure/game_invitation/fake_game_invitation_service.dart'
    as _i40;
import 'infrastructure/game_invitation/game_invitation_service.dart' as _i101;
import 'infrastructure/play/advanced_settings_service.dart' as _i20;
import 'infrastructure/play/dart_utils.dart' as _i32;
import 'infrastructure/play/fake_advanced_settings_service.dart' as _i99;
import 'infrastructure/play/offline/play_offline_service.dart' as _i42;
import 'infrastructure/play/online/fake_play_online_service.dart' as _i103;
import 'infrastructure/play/online/play_online_service.dart' as _i113;
...
import 'infrastructure/user/user_service.dart' as _i104;
import 'presentation/android/router.dart' as _i74;
import 'presentation/ios/router.dart' as _i73;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i28.IConnectivityService>(
      () => _i29.ConnectivityService(get<_i7.Connectivity>()),
      registerFor: {_test, _prod});
  gh.lazySingleton<_i28.IConnectivityService>(
      () => _i30.FakeConnectivityService(),
      registerFor: {_dev});
  ...
  gh.factory<_i55.InputRowBloc>(
      () => _i55.InputRowBloc(get<_i43.IScoreTrainingService>()));
  ...
  gh.factoryParam<_i63.KeyBoardBloc, List<Object>, dynamic>((otherDependencies,
          _) =>
      _i63.KeyBoardBloc.injectable(get<_i31.IDartUtils>(), otherDependencies));
  ...
  gh.factory<_i76.SearchUserBloc>(
      () => _i76.SearchUserBloc(get<_i35.IFriendService>()));
  gh.factory<_i77.SettingsBloc>(
      () => _i77.SettingsBloc(get<_i21.IAuthService>()));
  gh.factory<_i78.SignInBloc>(() => _i78.SignInBloc(get<_i21.IAuthService>()));
  gh.factory<_i79.SignUpBloc>(() => _i79.SignUpBloc(get<_i21.IAuthService>()));
  gh.factory<_i80.SingleTrainingWatcherCubit>(() =>
      _i80.SingleTrainingWatcherCubit(get<_i45.ISingleTrainingService>()));
  gh.lazySingleton<_i81.SocialClient>(() => jtdInjectableModule.socialClient);
  gh.factory<_i82.UserCubit>(() => _i82.UserCubit(get<_i47.IUserService>()));
  gh.factory<_i83.AuthBloc>(() => _i83.AuthBloc(get<_i21.IAuthService>()));
  gh.factory<_i84.BobsTwentySevenWatcherCubit>(() =>
      _i84.BobsTwentySevenWatcherCubit(get<_i23.IBobsTwentySevenService>()));
  gh.factory<_i85.ChangeEmailBloc>(
      () => _i85.ChangeEmailBloc(get<_i47.IUserService>()));
  gh.factory<_i86.ChangePasswordBloc>(
      () => _i86.ChangePasswordBloc(get<_i21.IAuthService>()));
  gh.factory<_i87.ChangeUsernameBloc>(
      () => _i87.ChangeUsernameBloc(get<_i47.IUserService>()));
  gh.factoryParam<_i88.CreateOfflineGameBloc, List<Object>, dynamic>(
      (otherDependencies, _) => _i88.CreateOfflineGameBloc.injectable(
          get<_i41.IPlayOfflineService>(), otherDependencies));
  gh.factoryParam<_i89.CreateOfflineGameCubit, List<Object>, dynamic>(
      (otherDependencies, _) => _i89.CreateOfflineGameCubit.injectable(
          get<_i41.IPlayOfflineService>(),
          get<_i19.IAdvancedSettingsService>(),
          otherDependencies));
  gh.factoryParam<_i90.CreateTrainingBloc, List<Object>, dynamic>(
      (otherDependencies, _) => _i90.CreateTrainingBloc.injectable(
          ...
          otherDependencies));
  gh.factoryParam<_i91.DartsDisplayerBloc, List<Object>, dynamic>(
      (otherDependencies, _) => _i91.DartsDisplayerBloc.injectable(
          get<_i31.IDartUtils>(), otherDependencies));
  gh.factory<_i92.DoubleTrainingWatcherCubit>(() =>
      _i92.DoubleTrainingWatcherCubit(get<_i33.IDoubleTrainingService>()));
  gh.factory<_i93.EditProfileImageBloc>(() => _i93.EditProfileImageBloc(
      get<_i49.ImagePicker>(), get<_i47.IUserService>()));
  gh.factory<_i94.ForgotPasswordBloc>(
      () => _i94.ForgotPasswordBloc(get<_i21.IAuthService>()));
  gh.factory<_i95.FriendsBloc>(
      () => _i95.FriendsBloc(get<_i35.IFriendService>()));
  gh.factory<_i96.FriendsCubit>(
      () => _i96.FriendsCubit(get<_i35.IFriendService>()));
  gh.factoryParam<_i97.GameHistoryBloc, List<Object>, dynamic>(
      (otherDependencies, _) => _i97.GameHistoryBloc.injectable(
          get<_i37.IGameHistoryService>(), otherDependencies));
  gh.factory<_i98.GameInvitationsCubit>(
      () => _i98.GameInvitationsCubit(get<_i39.IGameInvitationService>()));
  gh.lazySingleton<_i19.IAdvancedSettingsService>(
      () => _i99.FakeAdvancedSettingsService(get<_i21.IAuthService>()),
      registerFor: {_dev});
  gh.lazySingleton<_i21.IAuthService>(
      () => _i100.FirebaseAuthService(
          get<_i13.FirebaseAuth>(),
          get<_i5.AppleSignIn>(),
          get<_i17.GoogleSignIn>(),
          get<_i12.FacebookAuth>(),
          get<_i6.AuthProviderManager>(),
          get<_i81.SocialClient>()),
      registerFor: {_test, _prod});
  gh.lazySingleton<_i39.IGameInvitationService>(
      () => _i101.GameInvitationService(
          get<_i21.IAuthService>(),
          get<_i14.FirebaseFirestore>(),
          get<_i81.SocialClient>(),
          get<_i8.DartClient>()),
      registerFor: {_test, _prod});
  gh.lazySingleton<_i102.IPlayOnlineService>(
      () => _i103.FakePlayOnlineService(get<_i47.IUserService>()),
      registerFor: {_dev});
  gh.lazySingleton<_i47.IUserService>(
      () => _i104.UserService(
          get<_i14.FirebaseFirestore>(),
          ...
          get<_i81.SocialClient>()),
      registerFor: {_test, _prod});
  gh.factoryParam<_i105.InOnlineGameBloc, List<Object>, dynamic>(
      (otherDependencies, _) => _i105.InOnlineGameBloc.injectable(
          get<_i102.IPlayOnlineService>(), otherDependencies));
  gh.factoryParam<_i106.InputRowBlocOnlineDetailedInputArea, List<Object>,
          dynamic>(
      (otherDependencies, _) =>
          _i106.InputRowBlocOnlineDetailedInputArea.injectable(
              get<_i102.IPlayOnlineService>(), otherDependencies));
  gh.factoryParam<_i107.InputRowBlocOnlineStandardInputArea, List<Object>,
          dynamic>(
      (otherDependencies, _) =>
          _i107.InputRowBlocOnlineStandardInputArea.injectable(
              get<_i31.IDartUtils>(),
              get<_i102.IPlayOnlineService>(),
              otherDependencies));
  gh.factoryParam<_i108.CreateOnlineGameBloc, List<Object>, dynamic>(
      (otherDependencies, _) => _i108.CreateOnlineGameBloc.injectable(
          get<_i102.IPlayOnlineService>(), otherDependencies));
  gh.factory<_i109.CreateOnlineGameCubit>(
      () => _i109.CreateOnlineGameCubit(get<_i102.IPlayOnlineService>()));
  gh.factory<_i110.GameInvitationsBloc>(() => _i110.GameInvitationsBloc(
      get<_i102.IPlayOnlineService>(), get<_i39.IGameInvitationService>()));
  gh.lazySingleton<_i35.IFriendService>(
      () => _i111.FriendService(
          get<_i21.IAuthService>(),
      ...
      registerFor: {_test, _prod});
  gh.lazySingleton<_i37.IGameHistoryService>(
      () => _i112.GameHistoryService(
          get<_i14.FirebaseFirestore>(), get<_i35.IFriendService>()),
      registerFor: {_test, _prod});
  gh.lazySingleton<_i102.IPlayOnlineService>(
      () => _i113.PlayOnlineService(get<_i8.DartClient>(),
          get<_i47.IUserService>(), get<_i35.IFriendService>()),
      registerFor: {_test, _prod});
  return get;
}

class _$JtdInjectableModule extends _i114.JtdInjectableModule {}

class _$FireBaseInjectableModule extends _i115.FireBaseInjectableModule {}
