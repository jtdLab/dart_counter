...
import 'package:social_client/social_client.dart' as _i42;

import 'application/core/auth/auth_bloc.dart' as _i44;
import 'application/core/data_watcher/data_watcher_bloc.dart' as _i49;
import 'application/core/play/play_bloc.dart' as _i60;
...
import 'application/friends/friends_bloc.dart' as _i53;
import 'application/friends/more/more_bloc.dart' as _i36;
import 'application/friends/search_user/search_user_bloc.dart' as _i40;
import 'application/game_history/game_history_bloc.dart' as _i54;
...
import 'application/play/play_bloc.dart' as _i37;
import 'application/profile/profile_bloc.dart' as _i61;
import 'application/settings/change_email/change_email_bloc.dart' as _i46;
import 'application/settings/change_password/change_password_bloc.dart' as _i47;
import 'application/settings/change_username/change_username_bloc.dart' as _i48;
...
import 'application/sign_in/forgot_password/forgot_password_bloc.dart' as _i52;
...
import 'application/training/bobs_twenty_seven/bobs_twenty_seven_bloc.dart'
    as _i45;
import 'application/training/double_training/double_training_bloc.dart' as _i50;
import 'application/training/score_training/score_training_bloc.dart' as _i39;
import 'application/training/single_training/single_training_bloc.dart' as _i41;
import 'application/training/training_bloc.dart' as _i43;
...
import 'domain/play/game_snapshot.dart' as _i38;
import 'domain/play/i_play_offline_facade.dart' as _i28;
import 'domain/play/i_play_online_facade.dart' as _i57;
...
import 'infrastructure/auth/firebase_auth_facade.dart' as _i55;
...
import 'infrastructure/game_invitation/game_invitation_facade.dart' as _i56;
import 'infrastructure/game_invitation/mocked_game_invitation_facade.dart'
    as _i27;
import 'infrastructure/play/mocked_play_online_facade.dart' as _i58;
...
import 'infrastructure/user/user_facade.dart' as _i59;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factoryParam<_i37.PlayBloc, _i38.GameSnapshot?, dynamic>(
      (url, _) => _i37.PlayBloc(url));
  gh.lazySingleton<_i39.ScoreTrainingBloc>(
      () => _i39.ScoreTrainingBloc(get<_i30.IScoreTrainingService>()));
  gh.lazySingleton<_i40.SearchUserBloc>(
      () => _i40.SearchUserBloc(get<_i21.IFriendFacade>()));
  gh.lazySingleton<_i41.SingleTrainingBloc>(
      () => _i41.SingleTrainingBloc(get<_i32.ISingleTrainingService>()));
  gh.lazySingleton<_i42.SocialClient>(() => jtdInjectableModule.socialClient);
  gh.lazySingleton<_i43.TrainingBloc>(() => _i43.TrainingBloc(
  ...
  gh.lazySingleton<_i44.AuthBloc>(() => _i44.AuthBloc(get<_i12.IAuthFacade>()));
  gh.lazySingleton<_i45.BobsTwentySevenBloc>(
      () => _i45.BobsTwentySevenBloc(get<_i14.IBobsTwentySevenService>()));
  gh.lazySingleton<_i46.ChangeEmailBloc>(
      () => _i46.ChangeEmailBloc(get<_i34.IUserFacade>()));
  gh.lazySingleton<_i47.ChangePasswordBloc>(
      () => _i47.ChangePasswordBloc(get<_i12.IAuthFacade>()));
  gh.lazySingleton<_i48.ChangeUsernameBloc>(
      () => _i48.ChangeUsernameBloc(get<_i34.IUserFacade>()));
  gh.lazySingleton<_i49.DataWatcherBloc>(() => _i49.DataWatcherBloc(
      get<_i34.IUserFacade>(),
      get<_i26.IGameInvitationFacade>(),
      get<_i21.IFriendFacade>(),
      get<_i44.AuthBloc>()));
  gh.lazySingleton<_i50.DoubleTrainingBloc>(
      () => _i50.DoubleTrainingBloc(get<_i19.IDoubleTrainingService>()));
  gh.lazySingleton<_i51.EditProfileImageBloc>(
      () => _i51.EditProfileImageBloc(get<_i34.IUserFacade>()));
  gh.lazySingleton<_i52.ForgotPasswordBloc>(
      () => _i52.ForgotPasswordBloc(get<_i12.IAuthFacade>()));
  gh.lazySingleton<_i53.FriendsBloc>(() =>
      _i53.FriendsBloc(get<_i21.IFriendFacade>(), get<_i49.DataWatcherBloc>()));
  gh.lazySingleton<_i54.GameHistoryBloc>(() => _i54.GameHistoryBloc(
      get<_i34.IUserFacade>(), get<_i23.IGameHistoryFacade>()));
  gh.lazySingleton<_i12.IAuthFacade>(
      () => _i55.FirebaseAuthFacade(
          get<_i7.FirebaseAuth>(),
          get<_i11.GoogleSignIn>(),
          get<_i6.FacebookAuth>(),
          get<_i42.SocialClient>()),
      registerFor: {_test, _prod});
  gh.lazySingleton<_i26.IGameInvitationFacade>(
      () => _i56.GameInvitationFacade(
          get<_i12.IAuthFacade>(),
          get<_i8.FirebaseFirestore>(),
          get<_i42.SocialClient>(),
          get<_i5.DartClient>()),
      registerFor: {_test, _prod});
  gh.lazySingleton<_i57.IPlayOnlineFacade>(
      () => _i58.MockedPlayOnlineFacade(get<_i34.IUserFacade>()),
      registerFor: {_dev});
  gh.lazySingleton<_i34.IUserFacade>(
      () => _i59.UserFacade(
          get<_i8.FirebaseFirestore>(),
          ...
          get<_i42.SocialClient>()),
      registerFor: {_test, _prod});
  gh.lazySingleton<_i60.PlayBloc>(() => _i60.PlayBloc(
      get<_i28.IPlayOfflineFacade>(), get<_i57.IPlayOnlineFacade>()));
  gh.lazySingleton<_i61.ProfileBloc>(
      () => _i61.ProfileBloc(get<_i49.DataWatcherBloc>()));
  gh.lazySingleton<_i62.SettingsBloc>(() =>
      _i62.SettingsBloc(get<_i12.IAuthFacade>(), get<_i49.DataWatcherBloc>()));
  gh.lazySingleton<_i63.SignInBloc>(() =>
      _i63.SignInBloc(get<_i12.IAuthFacade>(), get<_i49.DataWatcherBloc>()));
  gh.lazySingleton<_i64.SignUpBloc>(() =>
      _i64.SignUpBloc(get<_i12.IAuthFacade>(), get<_i49.DataWatcherBloc>()));
  gh.lazySingleton<_i65.StatsBloc>(() => _i65.StatsBloc(get<_i60.PlayBloc>()));
  gh.lazySingleton<_i66.CreateGameBloc>(() => _i66.CreateGameBloc(
      get<_i28.IPlayOfflineFacade>(),
      get<_i57.IPlayOnlineFacade>(),
      get<_i60.PlayBloc>()));
  gh.lazySingleton<_i67.GameInvitationsBloc>(() => _i67.GameInvitationsBloc(
      get<_i57.IPlayOnlineFacade>(),
      get<_i26.IGameInvitationFacade>(),
      get<_i49.DataWatcherBloc>(),
      get<_i60.PlayBloc>()));
  gh.lazySingleton<_i68.HomeBloc>(() => _i68.HomeBloc(
      ...
      get<_i49.DataWatcherBloc>(),
      get<_i60.PlayBloc>(),
      get<_i43.TrainingBloc>()));
  gh.lazySingleton<_i21.IFriendFacade>(
      () => _i69.FriendFacade(get<_i12.IAuthFacade>(), get<_i34.IUserFacade>(),
          get<_i8.FirebaseFirestore>(), get<_i42.SocialClient>()),
      registerFor: {_test, _prod});
  gh.lazySingleton<_i57.IPlayOnlineFacade>(
      () =>
          _i70.PlayOnlineFacade(get<_i5.DartClient>(), get<_i34.IUserFacade>()),
      registerFor: {_test, _prod});
