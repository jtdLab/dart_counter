...
import 'package:social_client/social_client.dart' as _i66;

import 'application/auth/forgot_password/forgot_password_bloc.dart' as _i77;
import 'application/auth/sign_in/sign_in_bloc.dart' as _i63;
import 'application/auth/sign_up/sign_up_bloc.dart' as _i64;
...
import 'application/main/settings/edit_profile_image/edit_profile_image_bloc.dart'
    as _i76;
import 'application/main/settings/settings_bloc.dart' as _i62;
...
import 'application/main/training/single_training/watcher/single_training_watcher_cubit.dart'
    as _i65;
import 'application/shared/auth/auth_bloc.dart' as _i67;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factoryParam<_i44.InputRowBloc, _i41.InOfflineGameBloc?,
          _i45.DartsDisplayerBloc?>(
      (inOfflineGameBloc, dartsDisplayerBloc) => _i44.InputRowBloc(
  ...
  gh.factory<_i49.InputRowBloc>(
      () => _i49.InputRowBloc(get<_i33.IScoreTrainingService>()));
  ...
  gh.factoryParam<_i51.InputRowBloc, _i41.InOfflineGameBloc?, dynamic>(
      (inOfflineGameBloc, _) => _i51.InputRowBloc(
          get<_i31.IPlayOfflineService>(),
          get<_i23.IDartUtils>(),
          inOfflineGameBloc));
  gh.factoryParam<_i52.KeyBoardBloc, List<Object>?, dynamic>(
      (otherDependencies, _) => _i52.KeyBoardBloc(get<_i23.IDartUtils>(),
  ...
  gh.factoryParam<_i54.KeyBoardBloc, _i9.DartsDisplayerBloc?, dynamic>(
      (dartsDisplayerBloc, _) => _i54.KeyBoardBloc(
          get<_i25.IDoubleTrainingService>(), dartsDisplayerBloc));
  gh.factoryParam<_i55.KeyBoardBloc, _i9.DartsDisplayerBloc?, dynamic>(
      (dartsDisplayerBloc, _) => _i55.KeyBoardBloc(
          get<_i18.IBobsTwentySevenService>(), dartsDisplayerBloc));
  gh.factoryParam<_i56.KeyBoardBloc, _i49.InputRowBloc?, dynamic>(
      (inputRowBloc, _) =>
          _i56.KeyBoardBloc(get<_i23.IDartUtils>(), inputRowBloc));
  gh.factoryParam<_i57.KeyBoardBloc, _i4.AdvancedSettingsBloc?,
          _i51.InputRowBloc?>(
      (advancedSettingsBloc, inputRowBloc) => _i57.KeyBoardBloc(
          get<_i23.IDartUtils>(),
          get<_i31.IPlayOfflineService>(),
          advancedSettingsBloc,
          inputRowBloc));
  gh.factoryParam<_i58.KeyBoardBloc, _i9.DartsDisplayerBloc?, dynamic>(
      (dartsDisplayerBloc, _) => _i58.KeyBoardBloc(dartsDisplayerBloc));
  gh.factory<_i59.PlayOfflineWatcherCubit>(() => _i59.PlayOfflineWatcherCubit(
      get<_i31.IPlayOfflineService>(), get<_i37.IUserService>()));
  gh.lazySingleton<_i60.ProfileBloc>(
      () => _i60.ProfileBloc(get<_i37.IUserService>()));
  gh.factory<_i61.ScoreTrainingWatcherCubit>(
      () => _i61.ScoreTrainingWatcherCubit(get<_i33.IScoreTrainingService>()));
  gh.lazySingleton<_i62.SettingsBloc>(() =>
      _i62.SettingsBloc(get<_i16.IAuthService>(), get<_i37.IUserService>()));
  gh.lazySingleton<_i63.SignInBloc>(
      () => _i63.SignInBloc(get<_i16.IAuthService>()));
  gh.lazySingleton<_i64.SignUpBloc>(
      () => _i64.SignUpBloc(get<_i16.IAuthService>()));
  gh.factory<_i65.SingleTrainingWatcherCubit>(() =>
      _i65.SingleTrainingWatcherCubit(get<_i35.ISingleTrainingService>()));
  gh.lazySingleton<_i66.SocialClient>(() => jtdInjectableModule.socialClient);
  gh.lazySingleton<_i67.AuthBloc>(
      () => _i67.AuthBloc(get<_i16.IAuthService>()));
  gh.factory<_i68.BobsTwentySevenWatcherCubit>(() =>
      _i68.BobsTwentySevenWatcherCubit(get<_i18.IBobsTwentySevenService>()));
  gh.lazySingleton<_i69.ChangeEmailBloc>(
      () => _i69.ChangeEmailBloc(get<_i37.IUserService>()));
  gh.lazySingleton<_i70.ChangePasswordBloc>(
      () => _i70.ChangePasswordBloc(get<_i16.IAuthService>()));
  gh.lazySingleton<_i71.ChangeUsernameBloc>(
      () => _i71.ChangeUsernameBloc(get<_i37.IUserService>()));
  gh.factory<_i72.CreateOfflineGameBloc>(
      () => _i72.CreateOfflineGameBloc(get<_i31.IPlayOfflineService>()));
  gh.factory<_i73.CreateTrainingBloc>(() => _i73.CreateTrainingBloc(
  ...
  gh.factoryParam<_i45.DartsDisplayerBloc, _i74.AbstractIPlayService?, dynamic>(
      (playService, _) =>
          _i45.DartsDisplayerBloc(get<_i23.IDartUtils>(), playService));
  ...
  gh.factoryParam<_i87.InputRowBloc, _i45.DartsDisplayerBloc?, dynamic>(
  ...
  gh.factoryParam<_i89.KeyBoardBloc, List<Object>?, dynamic>(
      (otherDependencies, _) => _i89.KeyBoardBloc(get<_i23.IDartUtils>(),
          get<_i83.IPlayOnlineService>(), otherDependencies));
  gh.factoryParam<_i90.KeyBoardBloc, _i4.AdvancedSettingsBloc?,
          _i51.InputRowBloc?>(
      (advancedSettingsBloc, inputRowBloc) => _i90.KeyBoardBloc(
          get<_i23.IDartUtils>(),
          get<_i83.IPlayOnlineService>(),
          advancedSettingsBloc,
          inputRowBloc));
  gh.factory<_i91.PlayOnlineWatcherCubit>(
      () => _i91.PlayOnlineWatcherCubit(get<_i83.IPlayOnlineService>()));
  gh.lazySingleton<_i92.SearchUserBloc>(
      () => _i92.SearchUserBloc(get<_i80.IFriendService>()));
  gh.factory<_i93.CreateOnlineGameBloc>(
      () => _i93.CreateOnlineGameBloc(get<_i83.IPlayOnlineService>()));
  gh.lazySingleton<_i94.CreateOnlineGameCubit>(
      () => _i94.CreateOnlineGameCubit(get<_i83.IPlayOnlineService>()));
  gh.lazySingleton<_i95.FriendsBloc>(
      () => _i95.FriendsBloc(get<_i80.IFriendService>()));
