...
import 'application/core/training/create_training/create_training_bloc.dart'
    as _i45;
import 'application/core/training/in_training/in_training_bloc.dart' as _i56;
import 'application/core/training/post_training/post_training_bloc.dart'
    as _i59;
...
import 'application/post_game/post_game_bloc.dart' as _i58;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i34.IUserFacade>(
      () => _i55.UserFacade(
          ...
          get<_i39.SocialClient>()),
      registerFor: {_test, _prod});
  gh.lazySingleton<_i56.InTrainingBloc>(
      () => _i56.InTrainingBloc(get<_i40.TrainingBloc>()));
  gh.lazySingleton<_i57.PlayBloc>(() => _i57.PlayBloc(
      get<_i28.IPlayOfflineFacade>(), get<_i53.IPlayOnlineFacade>()));
  gh.lazySingleton<_i58.PostGameBloc>(
      () => _i58.PostGameBloc(get<_i57.PlayBloc>()));
  gh.lazySingleton<_i59.PostTrainingBloc>(
      () => _i59.PostTrainingBloc(get<_i40.TrainingBloc>()));
  gh.lazySingleton<_i60.SettingsBloc>(() =>
      _i60.SettingsBloc(get<_i12.IAuthFacade>(), get<_i46.DataWatcherBloc>()));
  gh.lazySingleton<_i61.SignInBloc>(() =>
      _i61.SignInBloc(get<_i12.IAuthFacade>(), get<_i46.DataWatcherBloc>()));
  gh.lazySingleton<_i62.SignUpBloc>(() =>
      _i62.SignUpBloc(get<_i12.IAuthFacade>(), get<_i46.DataWatcherBloc>()));
  gh.lazySingleton<_i63.StatsBloc>(() => _i63.StatsBloc(get<_i57.PlayBloc>()));
