...
import 'application/core/friends/friends_bloc.dart' as _i41;
import 'application/core/invitations/invitations_bloc.dart' as _i26;
import 'application/core/play/play_bloc.dart' as _i27;
...
import 'application/in_game/detailed_input_area/detailed_input_area_bloc.dart'
    as _i54;
import 'application/in_game/in_game_bloc.dart' as _i46;
...
import 'application/invitations/invitations_bloc.dart' as _i47;
import 'application/post_game/post_game_bloc.dart' as _i28;
...
import 'infrastructure/game_invitation/mocked_game_invitation_facade.dart'
    as _i17;
import 'infrastructure/play/mocked_play_offline_facade.dart' as _i44;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i27.PlayBloc>(() => _i27.PlayBloc(
      get<_i19.IPlayOfflineFacade>(), get<_i21.IPlayOnlineFacade>()));
  gh.lazySingleton<_i28.PostGameBloc>(
      () => _i28.PostGameBloc(get<_i27.PlayBloc>()));
  ...
  gh.lazySingleton<_i38.CreateGameBloc>(
      () => _i38.CreateGameBloc(get<_i27.PlayBloc>()));
  ...
  gh.lazySingleton<_i42.GameHistoryBloc>(
      () => _i42.GameHistoryBloc(get<_i33.UserBloc>()));
  gh.lazySingleton<_i43.HomeBloc>(() => _i43.HomeBloc(
      get<_i16.IGameInvitationFacade>(),
      get<_i13.IFriendFacade>(),
      get<_i33.UserBloc>(),
      get<_i27.PlayBloc>(),
      get<_i26.InvitationsBloc>(),
      get<_i41.FriendsBloc>()));
  gh.lazySingleton<_i19.IPlayOfflineFacade>(
      () => _i44.MockedPlayOfflineFacade(get<_i23.IUserFacade>()),
      registerFor: {_dev});
  gh.lazySingleton<_i21.IPlayOnlineFacade>(
      () => _i45.MockedPlayOnlineFacade(get<_i23.IUserFacade>()),
      registerFor: {_dev});
  gh.lazySingleton<_i46.InGameBloc>(
      () => _i46.InGameBloc(get<_i27.PlayBloc>()));
  gh.factory<_i47.InvitationsBloc>(() => _i47.InvitationsBloc(
      get<_i16.IGameInvitationFacade>(),
      get<_i21.IPlayOnlineFacade>(),
      get<_i27.PlayBloc>(),
      get<_i26.InvitationsBloc>()));
  ...
  gh.lazySingleton<_i52.StandardInputAreaBloc>(
      () => _i52.StandardInputAreaBloc(get<_i46.InGameBloc>()));
  gh.lazySingleton<_i53.CheckoutDetailsBloc>(
      () => _i53.CheckoutDetailsBloc(get<_i46.InGameBloc>()));
  gh.lazySingleton<_i54.DetailedInputAreaBloc>(
      () => _i54.DetailedInputAreaBloc(get<_i46.InGameBloc>()));
  return get;
}
