...
import 'application/auth/forgot_password/forgot_password_bloc.dart' as _i37;
import 'application/auth/sign_in/sign_in_bloc.dart' as _i30;
import 'application/auth/sign_up/sign_up_bloc.dart' as _i31;
import 'application/create_game/create_game_bloc.dart' as _i35;
...
import 'application/in_game/in_game_bloc.dart' as _i23;
import 'application/in_game/input_area/input_area_bloc.dart' as _i24;
...
import 'application/post_game/post_game_bloc.dart' as _i27;
import 'application/profile/profile_bloc.dart' as _i28;
import 'application/settings/edit_profile/edit_profile_bloc.dart' as _i36;
...
import 'infrastructure/core/jtd_injectable_module.dart' as _i42;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i20.IUserFacade>(
      ...
      registerFor: {_prod});
  gh.factory<_i23.InGameBloc>(() => _i23.InGameBloc(get<_i17.IPlayFacade>()));
  gh.factory<_i24.InputAreaBloc>(
      () => _i24.InputAreaBloc(get<_i17.IPlayFacade>()));
  gh.factory<_i25.InvitationsBloc>(
      () => _i25.InvitationsBloc(get<_i14.IGameInvitationFacade>()));
  gh.factory<_i26.PlayerDisplayerBloc>(
      () => _i26.PlayerDisplayerBloc(get<_i17.IPlayFacade>()));
  gh.factory<_i27.PostGameBloc>(
      () => _i27.PostGameBloc(get<_i17.IPlayFacade>()));
  gh.factory<_i28.ProfileBloc>(() => _i28.ProfileBloc(get<_i20.IUserFacade>()));
  gh.factory<_i29.SettingsBloc>(
      () => _i29.SettingsBloc(get<_i20.IUserFacade>()));
  gh.factory<_i30.SignInBloc>(() => _i30.SignInBloc(get<_i9.IAuthFacade>()));
  gh.factory<_i31.SignUpBloc>(() => _i31.SignUpBloc(get<_i9.IAuthFacade>()));
  gh.lazySingleton<_i32.SocialClient>(() => jtdInjectableModule.socialClient);
  gh.factory<_i33.SplashBloc>(() => _i33.SplashBloc(
      get<_i14.IGameInvitationFacade>(),
      get<_i12.IFriendFacade>(),
      get<_i20.IUserFacade>()));
  gh.factory<_i34.AuthBloc>(() => _i34.AuthBloc(get<_i9.IAuthFacade>()));
  gh.factory<_i35.CreateGameBloc>(
      () => _i35.CreateGameBloc(get<_i17.IPlayFacade>()));
  gh.factory<_i36.EditProfileBloc>(
      () => _i36.EditProfileBloc(get<_i20.IUserFacade>()));
  gh.factory<_i37.ForgotPasswordBloc>(
      () => _i37.ForgotPasswordBloc(get<_i9.IAuthFacade>()));
  gh.factory<_i38.FriendsBloc>(
      () => _i38.FriendsBloc(get<_i12.IFriendFacade>()));
  gh.factory<_i39.GameHistoryBloc>(
      () => _i39.GameHistoryBloc(get<_i20.IUserFacade>()));
  ...
  gh.lazySingleton<_i12.IFriendFacade>(
      () => _i41.FriendFacade(
          get<_i5.FirebaseFirestore>(), get<_i32.SocialClient>()),
      registerFor: {_prod});
  return get;
}

class _$JtdInjectableModule extends _i42.JtdInjectableModule {}
