...
import 'package:social_client/social_client.dart' as _i58;

import 'application/auth/forgot_password/forgot_password_bloc.dart' as _i68;
import 'application/auth/sign_in/sign_in_bloc.dart' as _i55;
import 'application/auth/sign_up/sign_up_bloc.dart' as _i56;
import 'application/main/friends/friends_bloc.dart' as _i82;
import 'application/main/friends/search_user/search_user_bloc.dart' as _i79;
import 'application/main/game_history/game_history_bloc.dart' as _i69;
import 'application/main/game_invitations/game_invitations_bloc.dart' as _i83;
import 'application/main/home/create_online_game/create_online_game_cubit.dart'
    as _i81;
import 'application/main/home/home_bloc.dart' as _i84;
...
import 'application/main/play/online/create_game/create_online_game_bloc.dart'
    as _i80;
import 'application/main/play/online/in_game/in_online_game_bloc.dart' as _i77;
import 'application/main/play/online/watcher/play_online_watcher_cubit.dart'
    as _i78;
import 'application/main/play/shared/in_game/points/points_cubit.dart' as _i50;
import 'application/main/play/shared/in_game/show_checkout_details/show_checkout_details_cubit.dart'
    as _i54;
import 'application/main/profile/profile_bloc.dart' as _i51;
import 'application/main/settings/change_email/change_email_bloc.dart' as _i61;
...
import 'application/main/settings/edit_profile_image/edit_profile_image_bloc.dart'
    as _i67;
import 'application/main/settings/settings_bloc.dart' as _i53;
...
import 'domain/play/online/i_play_online_service.dart' as _i74;
...
import 'infrastructure/auth/firebase_auth_service.dart' as _i70;
...
import 'infrastructure/core/firebase_injectable_module.dart' as _i89;
import 'infrastructure/core/jtd_injectable_module.dart' as _i88;
import 'infrastructure/friend/friend_service.dart' as _i85;
import 'infrastructure/friend/mocked_friend_service.dart' as _i72;
import 'infrastructure/game_history/game_history_service.dart' as _i86;
import 'infrastructure/game_history/mocked_game_history_service.dart' as _i25;
import 'infrastructure/game_invitation/game_invitation_service.dart' as _i73;
...
import 'infrastructure/play/online/mocked_play_online_service.dart' as _i75;
import 'infrastructure/play/online/play_online_service.dart' as _i87;
...
import 'infrastructure/user/user_service.dart' as _i76;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factoryParam<_i48.KeyBoardBloc, _i6.DartsDisplayerBloc?, dynamic>(
      (dartsDisplayerBloc, _) => _i48.KeyBoardBloc(
          get<_i15.IBobsTwentySevenService>(), dartsDisplayerBloc));
  gh.lazySingleton<_i49.PlayOfflineWatcherCubit>(() =>
      _i49.PlayOfflineWatcherCubit(
          get<_i28.IPlayOfflineService>(), get<_i34.IUserService>()));
  gh.lazySingleton<_i50.PointsCubit>(() => _i50.PointsCubit());
  gh.lazySingleton<_i51.ProfileBloc>(
      () => _i51.ProfileBloc(get<_i34.IUserService>()));
  gh.factory<_i52.ScoreTrainingWatcherCubit>(
      () => _i52.ScoreTrainingWatcherCubit(get<_i30.IScoreTrainingService>()));
  gh.lazySingleton<_i53.SettingsBloc>(() =>
      _i53.SettingsBloc(get<_i13.IAuthService>(), get<_i34.IUserService>()));
  gh.lazySingleton<_i54.ShowCheckoutDetailsCubit>(
      () => _i54.ShowCheckoutDetailsCubit());
  gh.lazySingleton<_i55.SignInBloc>(
      () => _i55.SignInBloc(get<_i13.IAuthService>()));
  gh.lazySingleton<_i56.SignUpBloc>(
      () => _i56.SignUpBloc(get<_i13.IAuthService>()));
  gh.factory<_i57.SingleTrainingWatcherCubit>(() =>
      _i57.SingleTrainingWatcherCubit(get<_i32.ISingleTrainingService>()));
  gh.lazySingleton<_i58.SocialClient>(() => jtdInjectableModule.socialClient);
  gh.lazySingleton<_i59.AuthBloc>(
      () => _i59.AuthBloc(get<_i13.IAuthService>()));
  gh.factory<_i60.BobsTwentySevenWatcherCubit>(() =>
      _i60.BobsTwentySevenWatcherCubit(get<_i15.IBobsTwentySevenService>()));
  gh.lazySingleton<_i61.ChangeEmailBloc>(
      () => _i61.ChangeEmailBloc(get<_i34.IUserService>()));
  gh.lazySingleton<_i62.ChangePasswordBloc>(
      () => _i62.ChangePasswordBloc(get<_i13.IAuthService>()));
  gh.lazySingleton<_i63.ChangeUsernameBloc>(
      () => _i63.ChangeUsernameBloc(get<_i34.IUserService>()));
  gh.lazySingleton<_i64.CreateOfflineGameBloc>(
      () => _i64.CreateOfflineGameBloc(get<_i28.IPlayOfflineService>()));
  gh.factory<_i65.CreateTrainingBloc>(
      () => _i65.CreateTrainingBloc(get<_i34.IUserService>()));
  gh.factory<_i66.DoubleTrainingWatcherCubit>(() =>
      _i66.DoubleTrainingWatcherCubit(get<_i22.IDoubleTrainingService>()));
  gh.lazySingleton<_i67.EditProfileImageBloc>(
      () => _i67.EditProfileImageBloc(get<_i34.IUserService>()));
  gh.lazySingleton<_i68.ForgotPasswordBloc>(
      () => _i68.ForgotPasswordBloc(get<_i13.IAuthService>()));
  gh.lazySingleton<_i69.GameHistoryBloc>(() => _i69.GameHistoryBloc(
      get<_i34.IUserService>(), get<_i24.IGameHistoryService>()));
  gh.lazySingleton<_i13.IAuthService>(
      () => _i70.FirebaseAuthService(
          get<_i8.FirebaseAuth>(),
          get<_i12.GoogleSignIn>(),
          get<_i7.FacebookAuth>(),
          get<_i58.SocialClient>()),
      registerFor: {_test, _prod});
  gh.lazySingleton<_i71.IFriendService>(
      () => _i72.MockedFriendService(
          get<_i13.IAuthService>(), get<_i34.IUserService>()),
      registerFor: {_dev});
  gh.lazySingleton<_i26.IGameInvitationService>(
      () => _i73.GameInvitationService(
          get<_i13.IAuthService>(),
          get<_i9.FirebaseFirestore>(),
          get<_i58.SocialClient>(),
          get<_i5.DartClient>()),
      registerFor: {_test, _prod});
  gh.lazySingleton<_i74.IPlayOnlineService>(
      () => _i75.MockedPlayOnlineService(get<_i34.IUserService>()),
      registerFor: {_dev});
  gh.lazySingleton<_i34.IUserService>(
      () => _i76.UserService(
          get<_i9.FirebaseFirestore>(),
          ...
          get<_i58.SocialClient>()),
      registerFor: {_test, _prod});
  gh.lazySingleton<_i77.InOnlineGameBloc>(
      () => _i77.InOnlineGameBloc(get<_i74.IPlayOnlineService>()));
  gh.lazySingleton<_i78.PlayOnlineWatcherCubit>(
      () => _i78.PlayOnlineWatcherCubit(get<_i74.IPlayOnlineService>()));
  gh.lazySingleton<_i79.SearchUserBloc>(
      () => _i79.SearchUserBloc(get<_i71.IFriendService>()));
  gh.lazySingleton<_i80.CreateOnlineGameBloc>(
      () => _i80.CreateOnlineGameBloc(get<_i74.IPlayOnlineService>()));
  gh.lazySingleton<_i81.CreateOnlineGameCubit>(
      () => _i81.CreateOnlineGameCubit(get<_i74.IPlayOnlineService>()));
  gh.lazySingleton<_i82.FriendsBloc>(
      () => _i82.FriendsBloc(get<_i71.IFriendService>()));
  gh.lazySingleton<_i83.GameInvitationsBloc>(() => _i83.GameInvitationsBloc(
      get<_i74.IPlayOnlineService>(), get<_i26.IGameInvitationService>()));
  gh.lazySingleton<_i84.HomeBloc>(() => _i84.HomeBloc(get<_i34.IUserService>(),
      get<_i26.IGameInvitationService>(), get<_i71.IFriendService>()));
  gh.lazySingleton<_i71.IFriendService>(
      () => _i85.FriendService(
          get<_i13.IAuthService>(),
      ...
      registerFor: {_test, _prod});
  gh.lazySingleton<_i24.IGameHistoryService>(
      () => _i86.GameHistoryService(get<_i9.FirebaseFirestore>(),
          get<_i34.IUserService>(), get<_i71.IFriendService>()),
      registerFor: {_test, _prod});
  gh.lazySingleton<_i74.IPlayOnlineService>(
      () => _i87.PlayOnlineService(get<_i5.DartClient>(),
          get<_i34.IUserService>(), get<_i71.IFriendService>()),
      registerFor: {_test, _prod});
  return get;
}

class _$JtdInjectableModule extends _i88.JtdInjectableModule {}
