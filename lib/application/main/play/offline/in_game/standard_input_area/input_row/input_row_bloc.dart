...
class InputRowBloc extends Bloc<InputRowEvent, int> {
  final IPlayOfflineService _playService;

  final IDartUtils _dartUtils;

  final InOfflineGameBloc _inOfflineGameBloc;

  InputRowBloc(
    this._playService,
    this._dartUtils,
    @factoryParam InOfflineGameBloc? inOfflineGameBloc,
  )   : _inOfflineGameBloc = inOfflineGameBloc!,
        // set inital state
        super(0) {
