...
class CreateOfflineGameBloc
  ...
  CreateOfflineGameBloc(
    this._playOfflineService,
          ...
          CreateOfflineGameState.initial(
            gameSnapshot: _playOfflineService.getGame(),
          ),
        ) {
    on<_WatchSnapshotsStarted>(
      (event, emit) async {
        await emit.forEach(
          _playOfflineService.watchGame(),
          onData: (OfflineGameSnapshot gameSnapshot) {
            return state.copyWith(gameSnapshot: gameSnapshot);
          },
        );
      },
    ...
    add(const CreateOfflineGameEvent.watchSnapshotsStarted());
  }
