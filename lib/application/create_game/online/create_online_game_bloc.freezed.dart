...
class _$_WatchSnapshotsStarted implements _WatchSnapshotsStarted {
  ...
  @override
  String toString() {
    return 'CreateOnlineGameEvent.watchSnapshotsStarted()';
  }
...
abstract class _WatchSnapshotsStarted implements CreateOnlineGameEvent {
...
class _$CreateOnlineGameStateTearOff {
  ...
  CreateOnlineGameInitial initial({required OnlineGameSnapshot gameSnapshot}) {
    return CreateOnlineGameInitial(
...
mixin _$CreateOnlineGameState {
  OnlineGameSnapshot get gameSnapshot => throw _privateConstructorUsedError;
  ...
  @JsonKey(ignore: true)
  $CreateOnlineGameStateCopyWith<CreateOnlineGameState> get copyWith =>
      throw _privateConstructorUsedError;
}
...
class _$CreateOnlineGameInitialCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(CreateOnlineGameInitial(
      gameSnapshot: gameSnapshot == freezed
          ? _value.gameSnapshot
          : gameSnapshot // ignore: cast_nullable_to_non_nullable
              as OnlineGameSnapshot,
...
class _$CreateOnlineGameInitial implements CreateOnlineGameInitial {
  const _$CreateOnlineGameInitial({required this.gameSnapshot});
  ...
  @override
  String toString() {
    return 'CreateOnlineGameState.initial(gameSnapshot: $gameSnapshot)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is CreateOnlineGameInitial &&
  ...
  @JsonKey(ignore: true)
  @override
  $CreateOnlineGameInitialCopyWith<CreateOnlineGameInitial> get copyWith =>
      _$CreateOnlineGameInitialCopyWithImpl<CreateOnlineGameInitial>(
          this, _$identity);
...
abstract class CreateOnlineGameInitial implements CreateOnlineGameState {
  const factory CreateOnlineGameInitial(
      {required OnlineGameSnapshot gameSnapshot}) = _$CreateOnlineGameInitial;
