...
class _$FailureReceived implements FailureReceived {
  ...
  @override
  String toString() {
    return 'UserEvent.failureReceived()';
  }
...
class _$UserStateTearOff {
  ...
  LoadSuccess loadSuccess({required User user}) {
    return LoadSuccess(
      user: user,
    );
  }
...
/// @nodoc
class _$LoadInProgressCopyWithImpl<$Res> extends _$UserStateCopyWithImpl<$Res>
...
abstract class LoadInProgress implements UserState {
...
class _$LoadSuccess implements LoadSuccess {
  const _$LoadSuccess({required this.user});
...
abstract class LoadSuccess implements UserState {
  const factory LoadSuccess({required User user}) = _$LoadSuccess;
