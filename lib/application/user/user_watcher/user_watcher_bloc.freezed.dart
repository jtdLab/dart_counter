...
/// @nodoc
class __$LoadCopyWithImpl<$Res> extends _$UserWatcherEventCopyWithImpl<$Res>
...
abstract class _Load implements UserWatcherEvent {
...
class _$UserWatcherStateTearOff {
  ...
  _LoadFailure loadFailure(UserFailure userFailure) {
    return _LoadFailure(
      userFailure,
    );
  }
...
abstract class _LoadFailure implements UserWatcherState {
  const factory _LoadFailure(UserFailure userFailure) = _$_LoadFailure;
