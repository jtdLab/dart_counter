...
import 'main/friends/friends_overview/friends_overview_page.dart' as _i12;
import 'main/friends/friends_profile/friends_profile_page.dart' as _i13;
...
class Router extends _i19.RootStackRouter {
  ...
  final Map<String, _i19.PageFactory> pagesMap = {
    ...
    FriendsOverviewPageRoute.name: (routeData) {
      return _i19.CustomPage<dynamic>(
          routeData: routeData,
          child: const _i12.FriendsOverviewPage(),
          customRouteBuilder: _i21.customRouteBuilder,
          opaque: true,
          barrierDismissible: false);
    },
    FriendsProfilePageRoute.name: (routeData) {
      return _i19.CustomPage<dynamic>(
          routeData: routeData,
          child: const _i13.FriendsProfilePage(),
    ...
    GameHistoryOverviewPageRoute.name: (routeData) {
      return _i19.CustomPage<dynamic>(
          routeData: routeData,
          child: const _i14.GameHistoryOverviewPage(),
          opaque: true,
          barrierDismissible: false);
    },
    GameHistoryDetailsPageRoute.name: (routeData) {
      return _i19.CustomPage<dynamic>(
          routeData: routeData,
          child: const _i15.GameHistoryDetailsPage(),
          reverseDurationInMilliseconds: 0,
          opaque: true,
          barrierDismissible: false);
    },
  ...
  List<_i19.RouteConfig> get routes => [
        ...
        _i19.RouteConfig(MainFlowRoute.name, path: '/main-flow', children: [
          ...
          _i19.RouteConfig(FriendsFlowRoute.name,
              path: 'friends-flow',
              children: [
                _i19.RouteConfig(FriendsOverviewPageRoute.name, path: ''),
          ...
          _i19.RouteConfig(GameHistoryFlowRoute.name,
              ...
              children: [
                _i19.RouteConfig(GameHistoryOverviewPageRoute.name, path: ''),
                _i19.RouteConfig(GameHistoryDetailsPageRoute.name,
...
/// generated route for [_i12.FriendsOverviewPage]
...
/// generated route for [_i13.FriendsProfilePage]
...
/// generated route for [_i14.GameHistoryOverviewPage]
class GameHistoryOverviewPageRoute extends _i19.PageRouteInfo<void> {
  const GameHistoryOverviewPageRoute() : super(name, path: '');

  static const String name = 'GameHistoryOverviewPageRoute';
}

/// generated route for [_i15.GameHistoryDetailsPage]
class GameHistoryDetailsPageRoute extends _i19.PageRouteInfo<void> {
