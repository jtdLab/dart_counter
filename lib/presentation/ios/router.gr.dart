...
import 'main/game/create_game/create_game_page.dart' as _i14;
import 'main/game/game_flow.dart' as _i11;
import 'main/game/in_game/in_game_page.dart' as _i15;
import 'main/game/post_game/post_game_page.dart' as _i16;
import 'main/game_history/details/details_page.dart' as _i13;
import 'main/game_history/game_history_flow.dart' as _i10;
import 'main/game_history/overview/overview_page.dart' as _i12;
...
class Router extends _i17.RootStackRouter {
  Router([_i18.GlobalKey<_i18.NavigatorState>? navigatorKey])
      : super(navigatorKey);
  ...
  final Map<String, _i17.PageFactory> pagesMap = {
    AuthFlowRoute.name: (routeData) {
      return _i17.CustomPage<dynamic>(
          ...
          customRouteBuilder: _i19.customRouteBuilder,
          opaque: true,
    ...
    CreateGamePageRoute.name: (routeData) {
      return _i17.CustomPage<dynamic>(
          routeData: routeData,
          child: const _i14.CreateGamePage(),
          customRouteBuilder: _i19.customRouteBuilder,
          opaque: true,
          barrierDismissible: false);
    },
    ...
    PostGamePageRoute.name: (routeData) {
      return _i17.CupertinoPageX<dynamic>(
          routeData: routeData, child: const _i16.PostGamePage());
    }
  };

  @override
  List<_i17.RouteConfig> get routes => [
        _i17.RouteConfig(AuthFlowRoute.name, path: '/auth-flow'),
        _i17.RouteConfig(MainFlowRoute.name, path: '/main-flow', children: [
          _i17.RouteConfig(HomePageRoute.name, path: ''),
          _i17.RouteConfig(SettingsPageRoute.name, path: 'settings-page'),
          _i17.RouteConfig(PrivacyPolicyPageRoute.name,
              path: 'privacy-policy-page'),
          _i17.RouteConfig(ContactPageRoute.name, path: 'contact-page'),
          _i17.RouteConfig(GameInvitationsPageRoute.name,
              path: 'game-invitations-page'),
          _i17.RouteConfig(FriendsFlowRoute.name,
              path: 'friends-flow',
              children: [
                _i17.RouteConfig(OverviewPageRoute.name, path: ''),
                _i17.RouteConfig(ProfilePageRoute.name, path: 'profile-page')
              ]),
          _i17.RouteConfig(ProfilePageRoute.name, path: 'profile-page'),
          _i17.RouteConfig(GameHistoryFlowRoute.name,
              path: 'game-history-flow',
              children: [
                _i17.RouteConfig(OverviewPageRoute.name, path: ''),
                _i17.RouteConfig(DetailsPageRoute.name, path: 'details-page')
              ]),
          _i17.RouteConfig(GameFlowRoute.name, path: 'game-flow', children: [
            _i17.RouteConfig(CreateGamePageRoute.name, path: ''),
            _i17.RouteConfig(InGamePageRoute.name, path: 'in-game-page'),
            _i17.RouteConfig(PostGamePageRoute.name, path: 'post-game-page')
          ])
        ])
      ];
}
...
class MainFlowRoute extends _i17.PageRouteInfo<void> {
  const MainFlowRoute({List<_i17.PageRouteInfo>? children})
...
class SettingsPageRoute extends _i17.PageRouteInfo<void> {
...
class ContactPageRoute extends _i17.PageRouteInfo<void> {
...
class GameInvitationsPageRoute extends _i17.PageRouteInfo<void> {
...
class FriendsFlowRoute extends _i17.PageRouteInfo<void> {
  const FriendsFlowRoute({List<_i17.PageRouteInfo>? children})
...
class GameHistoryFlowRoute extends _i17.PageRouteInfo<void> {
  const GameHistoryFlowRoute({List<_i17.PageRouteInfo>? children})
...
class GameFlowRoute extends _i17.PageRouteInfo<void> {
  const GameFlowRoute({List<_i17.PageRouteInfo>? children})
...
class OverviewPageRoute extends _i17.PageRouteInfo<void> {
  const OverviewPageRoute() : super(name, path: '');

  static const String name = 'OverviewPageRoute';
}

/// generated route for [_i13.DetailsPage]
class DetailsPageRoute extends _i17.PageRouteInfo<void> {
  const DetailsPageRoute() : super(name, path: 'details-page');

  static const String name = 'DetailsPageRoute';
}

/// generated route for [_i14.CreateGamePage]
class CreateGamePageRoute extends _i17.PageRouteInfo<void> {
  const CreateGamePageRoute() : super(name, path: '');

  static const String name = 'CreateGamePageRoute';
}

/// generated route for [_i15.InGamePage]
class InGamePageRoute extends _i17.PageRouteInfo<void> {
  const InGamePageRoute() : super(name, path: 'in-game-page');

  static const String name = 'InGamePageRoute';
}

/// generated route for [_i16.PostGamePage]
class PostGamePageRoute extends _i17.PageRouteInfo<void> {
