...
import '../../application/main/game_history/game_history_bloc.dart' as _i36;
import 'auth/auth_flow.dart' as _i1;
import 'core/core.dart' as _i35;
...
import 'main/play/online/create_game/create_online_game_page.dart' as _i24;
import 'main/play/online/in_game/in_online_game_flow.dart' as _i25;
import 'main/play/online/in_game/modals/stats/online_stats_modal.dart' as _i28;
import 'main/play/online/in_game/page/in_online_game_page.dart' as _i27;
import 'main/play/online/play_online_flow.dart' as _i12;
import 'main/play/online/post_game/post_online_game_page.dart' as _i26;
...
import 'main/training/create_training/create_training_page.dart' as _i29;
import 'main/training/in_training/in_training_page.dart' as _i30;
import 'main/training/post_training/post_training_page.dart' as _i31;
import 'main/training/training_flow.dart' as _i13;
import 'router.dart' as _i34;

class Router extends _i32.RootStackRouter {
  Router([_i33.GlobalKey<_i33.NavigatorState>? navigatorKey])
      : super(navigatorKey);
  ...
  final Map<String, _i32.PageFactory> pagesMap = {
    AuthFlowRoute.name: (routeData) {
      return _i32.CustomPage<dynamic>(
          ...
          customRouteBuilder: _i34.customRouteBuilder,
          opaque: true,
    ...
    CheckoutDetailsModalRoute.name: (routeData) {
      return _i32.CustomPage<dynamic>(
          ...
          customRouteBuilder: _i34.expandedModalRouteBuilder,
          opaque: true,
          barrierDismissible: false);
    },
    OfflineStatsModalRoute.name: (routeData) {
      return _i32.CustomPage<dynamic>(
          routeData: routeData,
          child: const _i23.OfflineStatsModal(),
          customRouteBuilder: _i34.expandedModalRouteBuilder,
          opaque: true,
          barrierDismissible: false);
    },
    CreateOnlineGamePageRoute.name: (routeData) {
      return _i32.CustomPage<dynamic>(
          routeData: routeData,
          child: const _i24.CreateOnlineGamePage(),
          customRouteBuilder: _i34.customRouteBuilder,
          opaque: true,
          barrierDismissible: false);
    },
    InOnlineGameFlowRoute.name: (routeData) {
      return _i32.CupertinoPageX<dynamic>(
          routeData: routeData, child: const _i25.InOnlineGameFlow());
    },
    PostOnlineGamePageRoute.name: (routeData) {
      return _i32.CupertinoPageX<dynamic>(
          routeData: routeData, child: const _i26.PostOnlineGamePage());
    },
    InOnlineGamePageRoute.name: (routeData) {
      return _i32.CustomPage<dynamic>(
          routeData: routeData,
          child: const _i27.InOnlineGamePage(),
          customRouteBuilder: _i34.customRouteBuilder,
          opaque: true,
          barrierDismissible: false);
    },
    OnlineStatsModalRoute.name: (routeData) {
      return _i32.CustomPage<dynamic>(
          routeData: routeData,
          child: const _i28.OnlineStatsModal(),
          customRouteBuilder: _i34.expandedModalRouteBuilder,
          opaque: true,
          barrierDismissible: false);
    },
    CreateTrainingPageRoute.name: (routeData) {
      return _i32.CupertinoPageX<dynamic>(
          routeData: routeData, child: const _i29.CreateTrainingPage());
    },
    InTrainingPageRoute.name: (routeData) {
      return _i32.CupertinoPageX<dynamic>(
          routeData: routeData, child: const _i30.InTrainingPage());
    },
    PostTrainingPageRoute.name: (routeData) {
      return _i32.CupertinoPageX<dynamic>(
          routeData: routeData, child: const _i31.PostTrainingPage());
    }
  };

  @override
  List<_i32.RouteConfig> get routes => [
        _i32.RouteConfig(AuthFlowRoute.name, path: '/auth-flow'),
        _i32.RouteConfig(MainFlowRoute.name, path: '/main-flow', children: [
          _i32.RouteConfig(HomePageRoute.name,
              path: '', parent: MainFlowRoute.name),
          _i32.RouteConfig(SettingsPageRoute.name,
              path: 'settings-page', parent: MainFlowRoute.name),
          _i32.RouteConfig(PrivacyPolicyPageRoute.name,
              path: 'privacy-policy-page', parent: MainFlowRoute.name),
          _i32.RouteConfig(ContactPageRoute.name,
              path: 'contact-page', parent: MainFlowRoute.name),
          _i32.RouteConfig(GameInvitationsPageRoute.name,
              path: 'game-invitations-page', parent: MainFlowRoute.name),
          _i32.RouteConfig(FriendsFlowRoute.name,
              path: 'friends-flow',
              ...
              children: [
                _i32.RouteConfig('#redirect',
                    ...
                    fullMatch: true),
                _i32.RouteConfig(FriendsOverviewPageRoute.name,
                    path: 'friends-overview-page',
                    parent: FriendsFlowRoute.name),
                _i32.RouteConfig(FriendsProfilePageRoute.name,
                    path: 'friends-profile-page', parent: FriendsFlowRoute.name)
              ]),
          _i32.RouteConfig(ProfilePageRoute.name,
              path: 'profile-page', parent: MainFlowRoute.name),
          _i32.RouteConfig(GameHistoryFlowRoute.name,
              ...
              children: [
                _i32.RouteConfig('#redirect',
                    ...
                    fullMatch: true),
                _i32.RouteConfig(GameHistoryOverviewPageRoute.name,
                    path: 'game-history-overview-page',
                    parent: GameHistoryFlowRoute.name),
                _i32.RouteConfig(GameHistoryDetailsPageRoute.name,
                    path: 'game-history-details-page',
                    parent: GameHistoryFlowRoute.name)
              ]),
          _i32.RouteConfig(PlayOfflineFlowRoute.name,
              path: 'play-offline-flow',
              parent: MainFlowRoute.name,
              children: [
                _i32.RouteConfig(CreateOfflineGamePageRoute.name,
                    path: '', parent: PlayOfflineFlowRoute.name),
                _i32.RouteConfig(InOfflineGameFlowRoute.name,
                    path: 'in-offline-game-flow',
                    parent: PlayOfflineFlowRoute.name,
                    children: [
                      _i32.RouteConfig(InOfflineGamePageRoute.name,
                          path: '', parent: InOfflineGameFlowRoute.name),
                      _i32.RouteConfig(CheckoutDetailsModalRoute.name,
                          path: 'checkout-details-modal',
                          parent: InOfflineGameFlowRoute.name),
                      _i32.RouteConfig(OfflineStatsModalRoute.name,
                          path: 'offline-stats-modal',
                          parent: InOfflineGameFlowRoute.name)
                    ]),
                _i32.RouteConfig(PostOfflineGamePageRoute.name,
                    path: 'post-offline-game-page',
                    parent: PlayOfflineFlowRoute.name)
              ]),
          _i32.RouteConfig(PlayOnlineFlowRoute.name,
              path: 'play-online-flow',
              parent: MainFlowRoute.name,
              children: [
                _i32.RouteConfig(CreateOnlineGamePageRoute.name,
                    path: '', parent: PlayOnlineFlowRoute.name),
                _i32.RouteConfig(InOnlineGameFlowRoute.name,
                    path: 'in-online-game-flow',
                    parent: PlayOnlineFlowRoute.name,
                    children: [
                      _i32.RouteConfig(InOnlineGamePageRoute.name,
                          path: '', parent: InOnlineGameFlowRoute.name),
                      _i32.RouteConfig(CheckoutDetailsModalRoute.name,
                          path: 'checkout-details-modal',
                          parent: InOnlineGameFlowRoute.name),
                      _i32.RouteConfig(OnlineStatsModalRoute.name,
                          path: 'online-stats-modal',
                          parent: InOnlineGameFlowRoute.name)
                    ]),
                _i32.RouteConfig(PostOnlineGamePageRoute.name,
                    path: 'post-online-game-page',
                    parent: PlayOnlineFlowRoute.name)
              ]),
          _i32.RouteConfig(TrainingFlowRoute.name,
              path: 'training-flow',
              parent: MainFlowRoute.name,
              children: [
                _i32.RouteConfig(CreateTrainingPageRoute.name,
                    path: '', parent: TrainingFlowRoute.name),
                _i32.RouteConfig(InTrainingPageRoute.name,
                    path: 'in-training-page', parent: TrainingFlowRoute.name),
                _i32.RouteConfig(PostTrainingPageRoute.name,
...
class AuthFlowRoute extends _i32.PageRouteInfo<void> {
...
class MainFlowRoute extends _i32.PageRouteInfo<void> {
  const MainFlowRoute({List<_i32.PageRouteInfo>? children})
...
class PrivacyPolicyPageRoute extends _i32.PageRouteInfo<void> {
...
class ContactPageRoute extends _i32.PageRouteInfo<void> {
...
class GameInvitationsPageRoute extends _i32.PageRouteInfo<void> {
...
class FriendsFlowRoute extends _i32.PageRouteInfo<void> {
  const FriendsFlowRoute({List<_i32.PageRouteInfo>? children})
...
class ProfilePageRoute extends _i32.PageRouteInfo<void> {
...
class GameHistoryFlowRoute
    extends _i32.PageRouteInfo<GameHistoryFlowRouteArgs> {
  GameHistoryFlowRoute(
      {_i35.Key? key,
      required _i36.GameHistoryBloc gameHistoryBloc,
...
class GameHistoryFlowRouteArgs {
  ...
  final _i36.GameHistoryBloc gameHistoryBloc;
...
class PlayOfflineFlowRoute extends _i32.PageRouteInfo<void> {
  const PlayOfflineFlowRoute({List<_i32.PageRouteInfo>? children})
...
class PlayOnlineFlowRoute extends _i32.PageRouteInfo<void> {
  const PlayOnlineFlowRoute({List<_i32.PageRouteInfo>? children})
...
class TrainingFlowRoute extends _i32.PageRouteInfo<void> {
  const TrainingFlowRoute({List<_i32.PageRouteInfo>? children})
...
class FriendsOverviewPageRoute extends _i32.PageRouteInfo<void> {
...
class FriendsProfilePageRoute extends _i32.PageRouteInfo<void> {
...
class GameHistoryOverviewPageRoute extends _i32.PageRouteInfo<void> {
...
class GameHistoryDetailsPageRoute extends _i32.PageRouteInfo<void> {
...
class CreateOfflineGamePageRoute extends _i32.PageRouteInfo<void> {
...
class InOfflineGameFlowRoute extends _i32.PageRouteInfo<void> {
  const InOfflineGameFlowRoute({List<_i32.PageRouteInfo>? children})
...
class PostOfflineGamePageRoute extends _i32.PageRouteInfo<void> {
...
class InOfflineGamePageRoute extends _i32.PageRouteInfo<void> {
...
class CheckoutDetailsModalRoute extends _i32.PageRouteInfo<void> {
...
/// generated route for [_i23.OfflineStatsModal]
class OfflineStatsModalRoute extends _i32.PageRouteInfo<void> {
  const OfflineStatsModalRoute() : super(name, path: 'offline-stats-modal');

  static const String name = 'OfflineStatsModalRoute';
}

/// generated route for [_i24.CreateOnlineGamePage]
class CreateOnlineGamePageRoute extends _i32.PageRouteInfo<void> {
  const CreateOnlineGamePageRoute() : super(name, path: '');

  static const String name = 'CreateOnlineGamePageRoute';
}

/// generated route for [_i25.InOnlineGameFlow]
class InOnlineGameFlowRoute extends _i32.PageRouteInfo<void> {
  const InOnlineGameFlowRoute({List<_i32.PageRouteInfo>? children})
      : super(name, path: 'in-online-game-flow', initialChildren: children);

  static const String name = 'InOnlineGameFlowRoute';
}

/// generated route for [_i26.PostOnlineGamePage]
class PostOnlineGamePageRoute extends _i32.PageRouteInfo<void> {
  const PostOnlineGamePageRoute() : super(name, path: 'post-online-game-page');

  static const String name = 'PostOnlineGamePageRoute';
}

/// generated route for [_i27.InOnlineGamePage]
class InOnlineGamePageRoute extends _i32.PageRouteInfo<void> {
  const InOnlineGamePageRoute() : super(name, path: '');

  static const String name = 'InOnlineGamePageRoute';
}

/// generated route for [_i28.OnlineStatsModal]
class OnlineStatsModalRoute extends _i32.PageRouteInfo<void> {
  const OnlineStatsModalRoute() : super(name, path: 'online-stats-modal');

  static const String name = 'OnlineStatsModalRoute';
}

/// generated route for [_i29.CreateTrainingPage]
class CreateTrainingPageRoute extends _i32.PageRouteInfo<void> {
  const CreateTrainingPageRoute() : super(name, path: '');

  static const String name = 'CreateTrainingPageRoute';
}

/// generated route for [_i30.InTrainingPage]
class InTrainingPageRoute extends _i32.PageRouteInfo<void> {
  const InTrainingPageRoute() : super(name, path: 'in-training-page');

  static const String name = 'InTrainingPageRoute';
}

/// generated route for [_i31.PostTrainingPage]
class PostTrainingPageRoute extends _i32.PageRouteInfo<void> {
