...
import '../../application/game_history/game_history_bloc.dart' as _i30;
import '../../domain/play/abstract_game_snapshot.dart' as _i31;
import 'auth/auth_flow.dart' as _i1;
import 'core/core.dart' as _i29;
...
import 'main/play/create_game/offline/create_offline_game_page.dart' as _i18;
import 'main/play/create_game/online/create_online_game_page.dart' as _i21;
import 'main/play/in_game/offline/in_offline_game_page.dart' as _i19;
import 'main/play/in_game/online/in_online_game_page.dart' as _i22;
import 'main/play/play_offline_flow.dart' as _i11;
import 'main/play/play_online_flow.dart' as _i12;
import 'main/play/post_game/post_game_page.dart' as _i20;
...
import 'main/training/create_training/create_training_page.dart' as _i23;
import 'main/training/in_training/in_training_page.dart' as _i24;
import 'main/training/post_training/post_training_page.dart' as _i25;
import 'main/training/training_flow.dart' as _i13;
import 'router.dart' as _i28;

class Router extends _i26.RootStackRouter {
  Router([_i27.GlobalKey<_i27.NavigatorState>? navigatorKey])
      : super(navigatorKey);
  ...
  final Map<String, _i26.PageFactory> pagesMap = {
    AuthFlowRoute.name: (routeData) {
      return _i26.CustomPage<dynamic>(
          ...
          customRouteBuilder: _i28.customRouteBuilder,
          opaque: true,
    ...
    PrivacyPolicyPageRoute.name: (routeData) {
      return _i26.CupertinoPageX<dynamic>(
    ...
    CreateTrainingPageRoute.name: (routeData) {
      return _i26.CupertinoPageX<dynamic>(
          routeData: routeData, child: const _i23.CreateTrainingPage());
    },
    InTrainingPageRoute.name: (routeData) {
      return _i26.CupertinoPageX<dynamic>(
          routeData: routeData, child: const _i24.InTrainingPage());
    },
    PostTrainingPageRoute.name: (routeData) {
      return _i26.CupertinoPageX<dynamic>(
          routeData: routeData, child: const _i25.PostTrainingPage());
    }
  };

  @override
  List<_i26.RouteConfig> get routes => [
        _i26.RouteConfig(AuthFlowRoute.name, path: '/auth-flow'),
        _i26.RouteConfig(MainFlowRoute.name, path: '/main-flow', children: [
          _i26.RouteConfig(HomePageRoute.name,
              path: '', parent: MainFlowRoute.name),
          _i26.RouteConfig(SettingsPageRoute.name,
              path: 'settings-page', parent: MainFlowRoute.name),
          _i26.RouteConfig(PrivacyPolicyPageRoute.name,
              path: 'privacy-policy-page', parent: MainFlowRoute.name),
          _i26.RouteConfig(ContactPageRoute.name,
              path: 'contact-page', parent: MainFlowRoute.name),
          _i26.RouteConfig(GameInvitationsPageRoute.name,
              path: 'game-invitations-page', parent: MainFlowRoute.name),
          _i26.RouteConfig(FriendsFlowRoute.name,
              path: 'friends-flow',
              ...
              children: [
                _i26.RouteConfig('#redirect',
                    ...
                    fullMatch: true),
                _i26.RouteConfig(FriendsOverviewPageRoute.name,
                    path: 'friends-overview-page',
                    parent: FriendsFlowRoute.name),
                _i26.RouteConfig(FriendsProfilePageRoute.name,
                    path: 'friends-profile-page', parent: FriendsFlowRoute.name)
              ]),
          _i26.RouteConfig(ProfilePageRoute.name,
              path: 'profile-page', parent: MainFlowRoute.name),
          _i26.RouteConfig(GameHistoryFlowRoute.name,
              ...
              children: [
                _i26.RouteConfig('#redirect',
                    ...
                    fullMatch: true),
                _i26.RouteConfig(GameHistoryOverviewPageRoute.name,
                    path: 'game-history-overview-page',
                    parent: GameHistoryFlowRoute.name),
                _i26.RouteConfig(GameHistoryDetailsPageRoute.name,
                    path: 'game-history-details-page',
                    parent: GameHistoryFlowRoute.name)
              ]),
          _i26.RouteConfig(PlayOfflineFlowRoute.name,
              path: 'play-offline-flow',
              parent: MainFlowRoute.name,
              children: [
                _i26.RouteConfig(CreateOfflineGamePageRoute.name,
                    path: '', parent: PlayOfflineFlowRoute.name),
                _i26.RouteConfig(InOfflineGamePageRoute.name,
                    path: 'in-offline-game-page',
                    parent: PlayOfflineFlowRoute.name),
                _i26.RouteConfig(PostGamePageRoute.name,
                    path: 'post-game-page', parent: PlayOfflineFlowRoute.name)
              ]),
          _i26.RouteConfig(PlayOnlineFlowRoute.name,
              path: 'play-online-flow',
              parent: MainFlowRoute.name,
              children: [
                _i26.RouteConfig(CreateOnlineGamePageRoute.name,
                    path: '', parent: PlayOnlineFlowRoute.name),
                _i26.RouteConfig(InOnlineGamePageRoute.name,
                    path: 'in-online-game-page',
                    parent: PlayOnlineFlowRoute.name),
                _i26.RouteConfig(PostGamePageRoute.name,
                    path: 'post-game-page', parent: PlayOnlineFlowRoute.name)
              ]),
          _i26.RouteConfig(TrainingFlowRoute.name,
              path: 'training-flow',
              parent: MainFlowRoute.name,
              children: [
                _i26.RouteConfig(CreateTrainingPageRoute.name,
                    path: '', parent: TrainingFlowRoute.name),
                _i26.RouteConfig(InTrainingPageRoute.name,
                    path: 'in-training-page', parent: TrainingFlowRoute.name),
                _i26.RouteConfig(PostTrainingPageRoute.name,
...
class AuthFlowRoute extends _i26.PageRouteInfo<void> {
...
class MainFlowRoute extends _i26.PageRouteInfo<void> {
  const MainFlowRoute({List<_i26.PageRouteInfo>? children})
...
class PrivacyPolicyPageRoute extends _i26.PageRouteInfo<void> {
...
class ContactPageRoute extends _i26.PageRouteInfo<void> {
...
class GameInvitationsPageRoute extends _i26.PageRouteInfo<void> {
...
class FriendsFlowRoute extends _i26.PageRouteInfo<void> {
  const FriendsFlowRoute({List<_i26.PageRouteInfo>? children})
...
class GameHistoryFlowRoute
    extends _i26.PageRouteInfo<GameHistoryFlowRouteArgs> {
  GameHistoryFlowRoute(
      {_i29.Key? key,
      required _i30.GameHistoryBloc gameHistoryBloc,
...
class GameHistoryFlowRouteArgs {
  ...
  final _i30.GameHistoryBloc gameHistoryBloc;
...
class PlayOfflineFlowRoute extends _i26.PageRouteInfo<void> {
  const PlayOfflineFlowRoute({List<_i26.PageRouteInfo>? children})
...
class PlayOnlineFlowRoute extends _i26.PageRouteInfo<void> {
  const PlayOnlineFlowRoute({List<_i26.PageRouteInfo>? children})
...
class TrainingFlowRoute extends _i26.PageRouteInfo<void> {
  const TrainingFlowRoute({List<_i26.PageRouteInfo>? children})
...
class FriendsOverviewPageRoute extends _i26.PageRouteInfo<void> {
...
class FriendsProfilePageRoute extends _i26.PageRouteInfo<void> {
...
class GameHistoryOverviewPageRoute extends _i26.PageRouteInfo<void> {
...
class GameHistoryDetailsPageRoute extends _i26.PageRouteInfo<void> {
...
class CreateOfflineGamePageRoute extends _i26.PageRouteInfo<void> {
...
class InOfflineGamePageRoute extends _i26.PageRouteInfo<void> {
  const InOfflineGamePageRoute() : super(name, path: 'in-offline-game-page');

  static const String name = 'InOfflineGamePageRoute';
}

/// generated route for [_i20.PostGamePage]
class PostGamePageRoute extends _i26.PageRouteInfo<PostGamePageRouteArgs> {
  PostGamePageRoute(
      {_i29.Key? key, required _i31.AbstractGameSnapshot gameSnapshot})
      : super(name,
            path: 'post-game-page',
...
class PostGamePageRouteArgs {
  ...
  final _i31.AbstractGameSnapshot gameSnapshot;
...
class CreateOnlineGamePageRoute extends _i26.PageRouteInfo<void> {
...
class InOnlineGamePageRoute extends _i26.PageRouteInfo<void> {
  const InOnlineGamePageRoute() : super(name, path: 'in-online-game-page');

  static const String name = 'InOnlineGamePageRoute';
}

/// generated route for [_i23.CreateTrainingPage]
class CreateTrainingPageRoute extends _i26.PageRouteInfo<void> {
  const CreateTrainingPageRoute() : super(name, path: '');

  static const String name = 'CreateTrainingPageRoute';
}

/// generated route for [_i24.InTrainingPage]
class InTrainingPageRoute extends _i26.PageRouteInfo<void> {
  const InTrainingPageRoute() : super(name, path: 'in-training-page');

  static const String name = 'InTrainingPageRoute';
}

/// generated route for [_i25.PostTrainingPage]
class PostTrainingPageRoute extends _i26.PageRouteInfo<void> {
