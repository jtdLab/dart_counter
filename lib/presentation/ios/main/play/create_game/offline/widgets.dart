part of 'create_offline_game_page.dart';
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        BlocBuilder<CreateOfflineGameBloc, CreateOfflineGameState>(
          builder: (context, state) {
            final startingPoints = state.gameSnapshot.startingPoints;
            final mode = state.gameSnapshot.mode;
            final type = state.gameSnapshot.type;
...
class _DartBotCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return BlocBuilder<CreateOfflineGameBloc, CreateOfflineGameState>(
      builder: (context, state) {
        final hasDartBot = state.gameSnapshot.hasDartBot();
