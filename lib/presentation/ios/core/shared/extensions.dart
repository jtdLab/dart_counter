...
extension ResponsiveValueX on Object {
  /// Returns a value depending on screen size.
  T responsiveValue<T>(
  ...
  // Provide these values in a more closed scope using extension or mixins for private sub widgets
