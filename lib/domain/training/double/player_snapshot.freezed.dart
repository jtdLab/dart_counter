...
class _$_PlayerSnapshot implements _PlayerSnapshot {
  ...
  @override
  String toString() {
    return 'PlayerSnapshot(id: $id, name: $name, isCurrentTurn: $isCurrentTurn, isFinished: $isFinished, targetValue: $targetValue, checkoutPercentage: $checkoutPercentage, missed: $missed, dartsThrown: $dartsThrown)';
  }
...
abstract class _PlayerSnapshot
  ...
  const factory _PlayerSnapshot(
      ...
      double? checkoutPercentage,
      required int missed,
      required int dartsThrown}) = _$_PlayerSnapshot;
