...
class _$_GameInvitation implements _GameInvitation {
  ...
  @override
  String toString() {
    return 'GameInvitation(id: $id, gameId: $gameId, toId: $toId, fromId: $fromId, fromName: $fromName, read: $read, createdAt: $createdAt)';
  }
...
abstract class _GameInvitation implements GameInvitation {
  const factory _GameInvitation(
      ...
      required Username fromName,
      required bool read,
      required DateTime createdAt}) = _$_GameInvitation;
