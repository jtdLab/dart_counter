...
import 'core/training/hit/abstract_round.dart';

export 'core/status.dart';
export 'core/training/hit/mode.dart';
export 'core/training/hit/hit.dart';

part 'core/training/hit/double/game.dart';
part 'core/training/hit/double/player.dart';
part 'core/training/hit/double/round.dart';
