...
_$_CreateGameResponsePacket _$_$_CreateGameResponsePacketFromJson(
    Map<String, dynamic> json) {
  return _$_CreateGameResponsePacket(
...
Map<String, dynamic> _$_$_CreateGameResponsePacketToJson(
