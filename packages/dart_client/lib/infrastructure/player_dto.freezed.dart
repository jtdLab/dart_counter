...
class _$_PlayerDto extends _PlayerDto {
  ...
  @override
  String toString() {
    return 'PlayerDto(id: $id, name: $name, isCurrentTurn: $isCurrentTurn, won: $won, wonSets: $wonSets, wonLegsCurrentSet: $wonLegsCurrentSet, pointsLeft: $pointsLeft, finishRecommendation: $finishRecommendation, lastPoints: $lastPoints, dartsThrownCurrentLeg: $dartsThrownCurrentLeg, stats: $stats, sets: $sets, userId: $userId)';
  }
...
abstract class _PlayerDto extends PlayerDto {
  const factory _PlayerDto(
      ...
      StatsDto? stats,
      List<SetDto>? sets,
      required String userId}) = _$_PlayerDto;
