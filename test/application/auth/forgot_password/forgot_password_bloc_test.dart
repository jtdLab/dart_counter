...
void main() {
  ...
  group('#Constructors#', () {
    ...
    group('#GetIt#', () {
      test(
          'GIVEN ForgotPasswordBloc is not registered inside getIt '
          'THEN throw error.', () {
        // Act & Assert
        expect(
      ...
      test(
        ...
        // Arrange
        final registeredInstance = ForgotPasswordBloc(mockAuthService);
        getIt.registerFactoryParam((param1, _) => registeredInstance);

        // Act
        final underTest = ForgotPasswordBloc.getIt();
