  ...
  group('#Methods#', () {
    group('#currentTurn#', () {
      test(
        ...
        // Arrange
        final snapshot = BobsTwentySevenGameSnapshot.dummy()
      ...
      test(
        ...
        // Arrange
        final snapshot = BobsTwentySevenGameSnapshot.dummy()
            .copyWith(status: Status.finished);
      ...
      test(
        ...
        // Arrange
        final owner = BobsTwentySevenPlayerSnapshot.dummy()
            .copyWith(isCurrentTurn: false);
        final currentTurn =
